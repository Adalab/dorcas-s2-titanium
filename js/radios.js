...
function cambiarFuente() {
  if (event.currentTarget.id === 'comicsans') {
    nombreVisor.classList.remove('montserrat');
    nombreVisor.classList.add('comicsans');
    footTextVisor.classList.remove('montserrat');
    footTextVisor.classList.add('comicsans');
    jobVisor.classList.remove('montserrat');
    jobVisor.classList.add('comicsans');
  }else if (event.currentTarget.id === 'montserrat'){
    nombreVisor.classList.remove('comicsans');
    nombreVisor.classList.add('montserrat');
    footTextVisor.classList.remove('comicsans');
    footTextVisor.classList.add('montserrat');
    jobVisor.classList.remove('comicsans');
